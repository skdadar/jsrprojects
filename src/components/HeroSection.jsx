...
function HeroSection() {
  ...
  return (
    <section className={`flex flex-col lg:flex-row items-center justify-between px-10 py-12 space-y-10 lg:space-y-0 ${isVisible ? 'fade-in' : 'hidden'}`}>
      {/* Left Side */}
      <div className="space-y-6 text-center lg:text-left">
        ...
        <button className="bg-orange-500 text-white px-8 py-2 rounded-full text-lg hover:bg-orange-600 transition duration-300 ease-in-out">
          Hire Us Now!
        </button>
      ...
      <div>
        ...
        <div className="border p-2 rounded-lg shadow-md text-center transition-transform transform hover:scale-105 duration-300 ease-in-out">
          <img src="/white.jpg" alt="Gallery" className="w-full h-auto" style={{ width: '370px', height: '200px' }} /></div>
          <h3 className="text-xl mt-2 font-bold text-center mb-6">Digitma Gallery</h3>
        </Link>
        <Link to="/videos" >
        <div className="border p-2 rounded-lg shadow-md text-center transition-transform transform hover:scale-105 duration-300 ease-in-out">
          <img src="/white.jpg" alt="Videos" className="w-full h-auto" style={{ width: '370px', height: '200px' }} /> </div>
          <h3 className="text-xl mt-2 font-bold text-center">Digitma Videos</h3>
        </Link>
      </div>
    </section>
  );
